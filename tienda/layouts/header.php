...
<nav class="navbar bg-dark navbar-expand-lg border-bottom-dark" data-bs-theme="dark">
    <div class="container-fluid mt-5">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarResponsive">
            <ul class="navbar-nav">
                <li class="nav-item"><a class="nav-link active navbar-brand mb-0 h1" aria-current="page" href="index.php">Inicio</a></li>
                <li class="nav-item"><a class="nav-link active navbar-brand mb-0 h1" aria-current="page" href="registrarProveedor.php">Registrar proveedor</a></li>
