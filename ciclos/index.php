                    ...
                    <div class="row gx-5 align-items-center">
                        <div class="col-lg-6">
                            ...
                            <div class="mb-5 mb-lg-0 text-center text-lg-start">
                                <h1 class="display-1 lh-1 mb-3">PHP</h1>
                                <p class="lead fw-normal text-muted mb-5">Bucles</p>
                ...
                <div class="container px-5">
                    <div class="row gx-5 align-items-center justify-content-evenly">
                        <div class="text-center">
                            <h2 class="text-dark">Expendio de naranjas</h2>
                        </div>
                        <div class="col-lg-8 order-lg-1 mb-5 mb-lg-0">
                            ...
                            ?>
                                <form action="" method="post">
                                    <?php
                                        $num = $_REQUEST['clientes'];
                                        for ($i=0; $i < $num; $i++) { 
                                    ?>
                                    <p>Cantidad de kilos de naranjas del cliente:  <?php echo ($i+1);?></p><input type="number" name="cantidad[]" />
                                    <br>
                                    <?php
                                        }
                                    ?>
                                ...
                                foreach($_REQUEST['cantidad'] as $cantidad) {
                                    echo "<h2>Cliente $j</h2>";
                                    if ($cantidad > 10) {
                                        $monto = $precio * $cantidad;
                                        $descuento = $monto * 0.15;
                                        $total = $monto - $descuento;
                                        echo "<p><b>Cantidad</b>: $cantidad</p>";
                                        echo "<p><b>descuento 15%:</b> $descuento</p>";
                                        echo "<p><b>Precio a pagar:</b> $total</p>";
                                        echo "<hr>";
                                    } else {
                                        $total = $precio * $cantidad;
                                        echo "<p><b>Cantidad</b>: $cantidad</p>";
                                        echo "<p><b>No tiene descuento</b></p>";
                                        echo "<p><b>Precio a pagar:</b> $total</p> ";
                                        echo "<hr>";
                                    }
                                    $j++;
                                ...
                                echo "<br><p><b>Total de ganancias:$acum </b></p>";
                            }       
                            ?>
                        </div> 
                    </div>
