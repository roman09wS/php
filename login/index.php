        ...
        <div class="row">
            <div class="col-12">
                <section class="vh-100">
                            ...
                            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                                <div class="card bg-dark text-white" style="border-radius: 1rem;">
                                    <div class="card-body p-5 text-center">
                                        ...
                                        <form action="" method="post">
                                            <div>
                                                <p class="mb-0">No tengo una cuenta?<button class="ms-2 fw-bold btn btn-outline-light" name="btn_registro">Registrarse</button></p>
                                            </div>
                                        </form>
                    ...
                    <?php if (isset($_POST['btn_registro'])) { ?>
                        <section class="vh-100">
