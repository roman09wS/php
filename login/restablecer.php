                                ...
                                <div class="card bg-dark text-white" style="border-radius: 1rem;">
                                    <div class="card-body p-5 text-center">
                                        ...
                                        <form action="" method="post">
                                            ...
                                            <button class="btn btn-outline-light btn-lg px-5" name="message" type="submit">Verificar</button>
                                        </form>
                                        <?php
                                        if (isset($_POST['message'])) {
                                            ...
                                            if ($enviado) {
                                                $conexion->query("INSERT INTO password (email,codigo) VALUES ('$correo',$codigo )") or die($conexion->error);                        
                                                echo '<div class="alert alert-success mt-5" role="alert">Verifica tu email para restablecer</div>';
                                            }
                                        }
                                        ?>
                                    </div>
