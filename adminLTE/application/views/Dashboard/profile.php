      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-3">
            ...
            <!-- Profile Image -->
            <div class="card card-p imary card-outline">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane" i ="activity">
                    <!-- Post -->
                    <div class="post">
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal" method="post">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="email" class="form-control" id="inputEmail" name="correo" placeholder="Email" value="<?= $correo;?>" rea>
                        </div>
                      </div>
                      <div class="form-group row">
