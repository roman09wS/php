    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-dark">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a class="nav-link active ms-3 fs-5 fw-semibold" href="/php/adminLTE/index.php/Dashboard/cerrar_sesion">Cerrar Session</a>
                </li>
            </ul>
                                        ...
                                        <tbody>
                                            <?php foreach ($usuarios as $key => $user) : ?>
                                                <tr>
                                                    ...
                                                    <td><?= $user->passw ?></td>
                                                    <td>
                                                        <a href="guardar/<?= $user->id_usuario ?>" class="btn bg-gradient-secondary"><i class="fas fa-edit"></i> Editar</a>
